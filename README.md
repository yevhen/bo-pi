...
| --- | --- | --- |
| [`@yevhen.b/bo-pi`](README.md) | `pi install npm:@yevhen.b/bo-pi` | Umbrella package that installs both Preflight and macOS Theme Sync together. |
...
Install both extensions at once:
...
- root `package.json` — umbrella package for both extensions
